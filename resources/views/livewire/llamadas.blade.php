            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
                ...
                <form class="w-full max-w-lg">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-80 md:w-1/3 px-3 mb-6 md:mb-0 px-2">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div class="w-80 md:w-1/4 px-3 px-2">
                            ...
                            <input wire:model.defer="call_answerBy" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Doe">
                            @error('call_answerBy') <span class="error">{{$message}}</span>@enderror
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap -mx-3">
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-80 md:w-1/4 px-3 mb-6 md:mb-0 px-2">
                                <button wire:click.prevent="submit()" class="inline-flex justify-center w-full rounded-md border border-gray-300 px-4 py-2 bg-white text-base leading-6 font-bold text-gray-700 shadow-sm hover:text-gray-700 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue transition ease-in-out duration-150 sm:text-sm sm:leading-5" type="submit">
                                    Guardar cambios
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-80 md:w-1/4 px-3 mb-6 md:mb-0 px-2">
                                <button wire:click.prevent="closeModalPopover()" type="button"
                                    class="inline-flex justify-center bg-purple-500 hover:bg-purple-400 w-full rounded-md border border-gray-300 px-4 py-2 bg-white text-base leading-6 font-bold text-gray-700 shadow-sm hover:text-gray-700 focus:outline-none focus:border-blue-300 focus:shadow-outline-blue transition ease-in-out duration-150 sm:text-sm sm:leading-5">
                                    Cerrar
                                </button>
                            </div>
                        </div>
